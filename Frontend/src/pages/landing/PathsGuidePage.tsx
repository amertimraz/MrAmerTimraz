...
const GUIDE = {
  name: 'مساعد تحديد المسار',
  tagline: 'معاك في خطوة تحديد المسار — ردود آلية بأسلوب بسيط',
...
const INTRO_TEXT = [
  'أهلاً 👋 أنا مساعد **تحديد المسار** على منصة **أ. عامر تمراز**.',
  'هنمشي سوا في خطوات بسيطة عشان **نحدد لك مسار بكالوريا** يقرب من ميولك — **مفيش إجابة غلط**، المهم الصدق مع نفسك.',
