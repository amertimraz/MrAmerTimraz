...
const features = [
  ...
  { icon: <Gamepad2 size={26} />,    title: 'ألعاب تعليمية (قريباً)',      description: 'نعمل على تطوير ألعاب تفاعلية مبتكرة لتعزيز تجربة التعلم وجعلها أكثر متعة.',                          color: 'text-green-600',  bg: 'bg-green-50',  border: 'border-green-100' },
